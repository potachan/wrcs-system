...
<tr>
<th><a href="<?php $_SERVER['SCRIPT_NAME'];?>?date=<?php echo $pre_week;?>&select_id=<?php echo $select_id;?>">&laquo; 前週</a></td>
<th><?php echo $year;?> 年 <?php echo $month;?> 月</td>
<th><a href="<?php $_SERVER['SCRIPT_NAME'];?>?date=<?php echo $next_week;?>&select_id=<?php echo $select_id;?>">次週 &raquo;</a></td>
</tr>


<tr><th class="col-md-1 col-xs-3">日付</th><th class="col-md-2 col-xs-4">費やした時間</th><th class="col-md-4 col-xs-5">内容</th></tr>
<?php echo "$table"; ?>
